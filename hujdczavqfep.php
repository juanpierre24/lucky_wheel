...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=332239');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "332239");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "bd9a23d57f5e6e2da7b3c082a49ba07edcc4c1897d3a7cff88267bf72e57c520");
define('CREATED_TIMESTAMP', "1573996498");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor332239');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor332239');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "jipyap.com",
));
